...
@section('content')
    ...
    <div class="mt-5 d-flex justify-content-end">
        <a href="/categories" class="btn btn-secondary"><i class="bi bi-arrow-left"></i>Back</a>
    </div>
            ...
            <tbody>
                @foreach ($deletedCategories as $item)
                    <tr>
                        ...
                        <td>{{ $item->name }}</td>
                        <td>
                            <a href="category-restore/{{ $item->slug }}" class="btn btn-primary me-3"><i class="bi bi-arrow-clockwise"></i>Restore</a>
